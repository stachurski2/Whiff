          ...
          (_measurement != null)
              ...
              : SizedBox(),
                ...
                Row(
                    ...
                    children: [
                      SizedBox(width: 30),
                      Text(widget.sensor.isInsideBuilding == true? AppLocalizations.of(context).translate("measurement_indoor_sensor_label") : AppLocalizations.of(context).translate("measurement_outdoor_sensor_label"),
                          style: TextStyle(fontSize: 16, fontFamily: 'Poppins'))
                      ]
                ),
      Row(
